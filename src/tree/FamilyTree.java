...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        TreeNode getNodeWithName(String targetName) {return getNodeWithName(targetName, "");}
        TreeNode getNodeWithName(String targetName, String indent)
        {
            // Does this node have the target name?
        	System.out.println(indent + "Seacrhing for: "+targetName);
        	System.out.println(indent + "lookin at: "+this.getName());
            ...
            for (TreeNode child: children)
            {
            	...
            	System.out.println(indent+"in for: looking at: "+child.getName());
            	TreeNode node = child.getNodeWithName(targetName, indent + " ");
            	if(node!=null);
            	{
            		return node;
            	}
        ...
        ArrayList<TreeNode> collectAncestorsToList()
        {
            ...
            TreeNode par_node = this.parent;
            while(par_node != null)
            {
            	ancestors.add(par_node);
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)	
		{
			throw new TreeException("colonindex below 0"); //a TreeException with a useful message
		}
		...
		else
		{
			...
			if(parentNode == null)
			{
				throw new TreeException("parent not found in data tree");
			}
		}
		System.out.println("root currently is: "+root.getName());
